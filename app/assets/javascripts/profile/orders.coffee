...
$(document).on('click', '#delete', (event) ->
  ...
  url = ' /profile/production_sites/' + production_sites + '/order_templates'
  ...
  $.ajax
    ...
    success: ->
      $('.order:has(input:checked)').each (index, element) ->
        $(this).fadeOut 500, ->
          $(this).remove()
          return
        return
...
$(document).on 'click', '#copy', ->
  ...
  url = ' /profile/production_sites/' + production_sites + '/order_templates/copy'
