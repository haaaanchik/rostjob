...
<% over_partial = render_escape '/partials/modal',
 { modal-production-site: 'modal-production-site', modal_title: 'Укажите данные о производственной площадке', local_render: partial_form, modal_id: 'modal-production-site' } %>
