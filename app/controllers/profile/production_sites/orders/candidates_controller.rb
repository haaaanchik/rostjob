class Profile::ProductionSites::Orders::CandidatesController < Profile::ProductionSites::Orders::ApplicationController
  ...
  def hire
    ...
    Cmd::ProposalEmployee::ToHire.call(candidate: candidate, hiring_date: candidate_params[:hiring_date])
  ...
  def to_interview
    ...
    result = Cmd::ProposalEmployee::ToInterview.call(proposal_employee: candidate,
