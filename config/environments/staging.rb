Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = ['http://stage.rostjob.com']
  ...
  #   port: 587,
  #   user_name: 'noreply@rostjob.ru',
  #   password: %(R@OYLwGPTLHmC{guja~#),
  #   # user_name: 'rostjob@bk.ru',
  ...
  config.action_mailer.default_url_options = { host: 'stage.rostjob.com' }
